    ...
    <div class="container-fluid px-0">
        ...
        <div class="side-bar side-bar-lg-active" data-theme="purple">
            ...
            <div class="side-menu-brand d-flex flex-column justify-content-center align-items-center clear mt-3">
                <img src="{{ asset('admin/img/QbyteIcon.png') }}" alt="bran_name" class="brand-img">
                ...
                <div id="accordion">
                    <ul class="side-menu p-0 m-0 mt-3">
                        <li class="side-menu-item px-3">
                            <a href="{{ route('home') }}" class="w-100 py-3 pl-4">Dashboard</a>
                        </li>
                        <!-- Sub menu parent -->
                        <li class="side-menu-item px-3">
                            <a href="#" class="w-100 py-3 pl-4 sub-menu-parent" data-toggle="collapse"
                               data-target="#sub_menu_1" aria-expanded="false" aria-controls="sub_menu_1">
                                Basic UI Elements
                            </a>
                        </li>
                        <!-- Sub menu -->
                        <div id="sub_menu_1" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                            <ul class="side-sub-menu p-0">
                                <li class="side-sub-menu-item px-3"><a href="alert.html" class="w-100 pl-4">Alert</a>
                                </li>
                                <li class="side-sub-menu-item px-3"><a href="accordion.html" class="w-100 pl-4">Accordion</a>
                                </li>
                                <li class="side-sub-menu-item px-3"><a href="badge.html" class="w-100 pl-4">Badge</a>
                                </li>
                                <li class="side-sub-menu-item px-3"><a href="button.html" class="w-100 pl-4">Button</a>
                                </li>
                                <li class="side-sub-menu-item px-3"><a href="bootstrap_tab.html" class="w-100 pl-4">Bootstrap
                                        tab</a></li>
                                <li class="side-sub-menu-item px-3"><a href="cards.html" class="w-100 pl-4">Cards</a>
                                </li>
                                <li class="side-sub-menu-item px-3"><a href="carousels.html" class="w-100 pl-4">Carousels</a>
                                </li>
                                <li class="side-sub-menu-item px-3"><a href="dropdown.html"
                                                                       class="w-100 pl-4">Dropdown</a></li>
                                <li class="side-sub-menu-item px-3"><a href="list.html" class="w-100 pl-4">Llist</a>
                                </li>
                                <li class="side-sub-menu-item px-3"><a href="modal.html" class="w-100 pl-4">Modals</a>
                                </li>
                                <li class="side-sub-menu-item px-3"><a href="paginations.html" class="w-100 pl-4">Paginations</a>
                                </li>
                                <li class="side-sub-menu-item px-3"><a href="progressbar.html" class="w-100 pl-4">Progressbar</a>
                                </li>
                                <li class="side-sub-menu-item px-3"><a href="tooltip.html"
                                                                       class="w-100 pl-4">Tooltip</a></li>
                                <li class="side-sub-menu-item px-3"><a href="typography.html" class="w-100 pl-4">Typography</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <li class="side-menu-item px-3"><a href="#" class="w-100 py-3 pl-4 sub-menu-parent"
                                                           data-toggle="collapse" data-target="#form-sub-menu"
                                                           aria-expanded="false" aria-controls="form-sub-menu">Form
                                Elements</a></li>
                        <!-- Sub menu -->
                        <div id="form-sub-menu" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                            <ul class="side-sub-menu p-0">
                                <li class="side-sub-menu-item px-3"><a href="form_basic.html" class="w-100 pl-4">Basic
                                        Elements</a></li>
                                <li class="side-sub-menu-item px-3"><a href="form_basic_action.html" class="w-100 pl-4">Basic
                                        Action Bar</a></li>
                                ...
                                <li class="side-sub-menu-item px-3"><a href="input_group.html" class="w-100 pl-4">Input
                                        Group</a></li>
                                <li class="side-sub-menu-item px-3"><a href="form_validation.html" class="w-100 pl-4">Form
                                        Validation</a></li>
                            </ul>
                        </div>
                        ...
                        <!-- Sub menu parent -->
                        <li class="side-menu-item px-3"><a href="#" class="w-100 py-3 pl-4 sub-menu-parent"
                                                           data-toggle="collapse" data-target="#chart-sub-menu"
                                                           aria-expanded="false"
                        ...
                        <!-- Sub menu parent -->
                        <li class="side-menu-item px-3"><a href="#" class="w-100 py-3 pl-4 sub-menu-parent"
                                                           data-toggle="collapse" data-target="#table-sub-menu"
                                                           aria-expanded="false"
                        ...
                        <div id="table-sub-menu" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                            <ul class="side-sub-menu p-0">
                                <li class="side-sub-menu-item px-3"><a href="basic_table.html" class="w-100 pl-4">Basic
                                        Table</a></li>
                                <li class="side-sub-menu-item px-3"><a href="datatables.html" class="w-100 pl-4">DataTables</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <!-- Sub menu parent -->
                        <li class="side-menu-item px-3"><a href="#" class="w-100 py-3 pl-4 sub-menu-parent"
                                                           data-toggle="collapse" data-target="#sub_menu_2"
                                                           aria-expanded="true" aria-controls="sub_menu_2">User
                                Pages</a></li>
                        <!-- Sub menu -->
                        <div id="sub_menu_2" class="collapse show" aria-labelledby="headingOne"
                             data-parent="#accordion">
                            <ul class="side-sub-menu p-0">
                                <li class="side-sub-menu-item px-3"><a href="blank.html" class="w-100 pl-4 small">Blank
                                        Page</a></li>
                                <li class="side-sub-menu-item px-3"><a href="login.html"
                                                                       class="w-100 pl-4 small active">Login</a></li>
                                <li class="side-sub-menu-item px-3"><a href="signup.html" class="w-100 pl-4 small">Register</a>
                                </li>
                                <li class="side-sub-menu-item px-3"><a href="404.html" class="w-100 pl-4 small">404</a>
                                </li>
                                <li class="side-sub-menu-item px-3"><a href="500.html" class="w-100 pl-4 small">500</a>
                                </li>
                            </ul>
                        </div>
                    </ul>
                ...
                <div class="navb-menu ml-auto d-flex flex-row">
                            ...
                            <a href="#" class="dropdown-item text-secondary-light p-0">
                                <div class="d-flex flex-row border-bottom">
                                    ...
                                    <div class="notification-icon bg-secondary-c pt-3"><img
                                            src="{{ asset('admin/img/profile.jpg') }}" alt="img"
                    ...
                    <div class="dropdown dropdown-arow-none d-contents text-center mx-2">
                        ...
                        <a href="#" class="w-100 dropdown-toggle text-muted" data-toggle="dropdown"><img
                                src="{{ asset('admin/img/profile.jpg') }}" alt="profile" class="profile-avatar"></a>
                        <!-- Dropdown Menu -->
                    ...
                    <div class="col-lg-8 col-md-12 mt-4 mt-lg-0">
                        ...
                        <div class="card border-0 rounded-lg">
                            ...
                            <div class="card-body">
                                ...
                                <!-- Chart -->
                                <div id="echartBar"
                                     style="height: 300px; -webkit-tap-highlight-color: transparent; user-select: none; position: relative;"></div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-12 mt-4 mt-lg-0">
                        ...
                        <div class="card border-0 rounded-lg">
                            ...
                            <div class="card-body">
                                ...
                                <!-- Chart -->
                                <div id="echartPie"
                                     style="width:100%;height: 300px; -webkit-tap-highlight-color: transparent; user-select: none; position: relative;"></div>
                            </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-6 col-md-12 mt-4 mt-lg-0">
                                ...
                                <div class="card border-0 rounded-lg">
                                    ...
                                    <!-- Chart -->
                                    <div id="echart1"
                                         style="height: 260px; -webkit-tap-highlight-color: transparent; user-select: none; position: relative;"></div>
                                </div>
                                    ...
                                    <div class="card-header border-0">
                                        ...
                                        <div class="dropdown dropdown-arow-none dropleft float-right">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a href="#" class="dropdown-item text-secondary-light">Something else
                                                    here</a>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table text-dark">
                                                ...
                                                <tr class="text-center">
                                                    ...
                                                    <td><img src="{{ asset('admin/img/profile.jpg') }}" alt="Avatar"
                                                             class="profile-avatar w-50 mb-0"></td>
                                                ...
                                                <tr class="text-center">
                                                    ...
                                                    <td><span class="badge badge-warning badge-pill">Not Active</span>
                                                    </td>
                                                    <td class="p-3">
                                                        <div
                                                            class="d-flex flex-row justify-content-around align-items-center">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex flex-row">
                                                ...
                                                <div class="product-thumbnail w-15">
                                                    <img src="{{ asset('admin/img/headphone-4.jpg') }}"
                                                         alt="product" class="w-100 h-75">
                                                </div>
                                                <!-- Product info -->
                                                <div class="produst-info ml-4">
                                                    <h6 class="text-primary font-weight-normal">Wireless Headphone
                                                        E23</h6>
                                                    <p class="mb-0 text-secondary-light">Lorem ipsum dolor sit amet
                                                        consectetur.</p>
                                                    <p class="text-danger">$450
                                                        <del class="text-secondary-light">$500</del>
                                                    </p>
                                                </div>
                                            </div>
                                            <!-- Details Button -->
                                            <button
                                                class="btn w-50 btn-outline-primary rounded btn-sm align-self-center mb-4">
                                                View details
                                            </button>
                                        </div>
                                        <!-- Top selling product list -->
                                        <div
                                            ...
                                            <div class="d-flex flex-row">
                                                ...
                                                <div class="produst-info ml-4">
                                                    ...
                                                    <p class="mb-0 text-secondary-light">Lorem ipsum dolor sit amet
                                                        consectetur.</p>
                                                    <p class="text-danger">$550
                                                        <del class="text-secondary-light">$600</del>
                                                    </p>
                                                </div>
                                            </div>
                                            <!-- Details Button -->
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex flex-row">
                                                <!-- Product thumbnail -->
                                                <div class="product-thumbnail w-15">
                                                    <img src="{{ asset('admin/img/headphone-3.jpg') }}"
                                                         alt="product" class="w-100 h-75">
                                                </div>
                                                <!-- Product info -->
                                                <div class="produst-info ml-4">
                                                    ...
                                                    <p class="mb-0 text-secondary-light">Lorem ipsum dolor sit amet
                                                        consectetur.</p>
                                                    <p class="text-danger">$250
                                                        <del class="text-secondary-light">$300</del>
                                                    </p>
                                                </div>
                                            </div>
                                            <!-- Details Button -->
                            ...
                            <div class="col-12">
                                ...
                                <div class="card border-0 rounded-lg">
                                    ...
                                    <div class="card-body p-0">
                                        <!-- Card title -->
                                        <div
                                            class="card-title m-0 p-3 d-flex flex-row align-items-center justify-content-between">
                                            <span>User activity</span>
                                            <span
                                                class="badge badge-pill badge-warning font-weight-normal">Update daily</span>
                                        </div>
                                        <!-- Activity details -->
                    ...
                    <div class="col-12 mt-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body p-0">
                                ...
                                <!-- Chart -->
                                <div id="echart3"
                                     style="height: 360px; -webkit-tap-highlight-color: transparent; user-select: none; position: relative;"></div>
                            </div>
